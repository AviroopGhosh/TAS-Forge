...
- Helpful Resources:
    -  [Getting started with OMNeT++ and INET](https://www.youtube.com/watch?v=PfAWhrmoYgM)
    -  [TSN INET Showcases](https://inet.omnetpp.org/docs/showcases/tsn/index.html)
...
<pre>
    ...
    ├── output_CPLEX_solution_[sched].txt      % Decision variable output text file generated by CPLEX based on scheduler type
    ...
    ├── stream_data_output_[sched].csv         % Analysis of the results generated by OMNeT++ based on scheduler type (created by running analyze_omnet_results.m)
