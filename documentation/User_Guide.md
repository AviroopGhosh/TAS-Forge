...
- Check the vector results generated by the OMNeT++ simulation file. 
- Filter the results based on the result column on the 'meanBitLifeTimePerPacket:vector'.
- This results give the end-to-end latency for each frame based on stream.
