...
-  🧭 **Consult the Logs:**
  Look for `!!!` markers in the MATLAB console. These error messages are generated by TAS-Forge to singal critical errors. Refer to this documentation for an understanding of their likely root causes.
