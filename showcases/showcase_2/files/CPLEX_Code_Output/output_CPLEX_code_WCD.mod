...
lambda_3 == OFF_3_switch5  - OFF_3_source4 + (trans_delay[3] + prop_delay);
lambda_4 == OFF_4_switch5  - OFF_4_source2 + (trans_delay[4] + prop_delay);
lambda_5 == OFF_5_switch6  - OFF_5_source3 + (trans_delay[5] + prop_delay);
