...
// Stream 1
OFF_1_switch3 >= OFF_1_source5 + ceil(L[1] + delta + 1);
// Stream 2
OFF_2_switch2 >= OFF_2_source4 + ceil(L[2] + delta + 1);
OFF_2_switch3 >= OFF_2_switch2 + ceil(L[2] + delta + 1);
// Stream 3
OFF_3_switch3 >= OFF_3_source5 + ceil(L[3] + delta + 1);
...
// Stream 5
OFF_5_switch1 >= OFF_5_source1 + ceil(L[5] + delta + 1);
OFF_5_switch2 >= OFF_5_switch1 + ceil(L[5] + delta + 1);
OFF_5_switch3 >= OFF_5_switch2 + ceil(L[5] + delta + 1);
// Stream 6
OFF_6_switch1 >= OFF_6_source2 + ceil(L[6] + delta + 1);
...
// Stream 7
OFF_7_switch1 >= OFF_7_source3 + ceil(L[7] + delta + 1);
OFF_7_switch2 >= OFF_7_switch1 + ceil(L[7] + delta + 1);
OFF_7_switch3 >= OFF_7_switch2 + ceil(L[7] + delta + 1);
OFF_7_switch4 >= OFF_7_switch3 + ceil(L[7] + delta + 1);
...
lambda_2 == OFF_2_switch3  - OFF_2_source4 + (trans_delay[2] + prop_delay);
lambda_3 == OFF_3_switch5  - OFF_3_source5 + (trans_delay[3] + prop_delay);
lambda_4 == OFF_4_switch3  - OFF_4_source2 + (trans_delay[4] + prop_delay);
lambda_5 == OFF_5_switch3  - OFF_5_source1 + (trans_delay[5] + prop_delay);
lambda_6 == OFF_6_switch4  - OFF_6_source2 + (trans_delay[6] + prop_delay);
lambda_7 == OFF_7_switch4  - OFF_7_source3 + (trans_delay[7] + prop_delay);
