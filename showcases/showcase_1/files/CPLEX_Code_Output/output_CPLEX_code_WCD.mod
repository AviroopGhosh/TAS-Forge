...
// Stream 3
OFF_3_switch1 >= OFF_3_source4 + ceil(L[3] + delta + 1);
...
// Stream 4
OFF_4_switch1 >= OFF_4_source1 + ceil(L[4] + delta + 1);
...
// Stream 5
OFF_5_switch1 >= OFF_5_source3 + ceil(L[5] + delta + 1);
OFF_5_switch2 >= OFF_5_switch1 + ceil(L[5] + delta + 1);
