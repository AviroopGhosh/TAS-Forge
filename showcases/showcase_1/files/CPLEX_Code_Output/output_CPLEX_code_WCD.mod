...
int trans_delay_var[N_streams] = [13, 13, 13, 13, 13];
...
// Stream 3
OFF_3_switch1 >= OFF_3_source4 + ceil(L[3] + delta);
OFF_3_switch2 >= OFF_3_switch1 + ceil(L[3] + delta);
OFF_3_switch3 >= OFF_3_switch2 + ceil(L[3] + delta);
OFF_3_switch4 >= OFF_3_switch3 + ceil(L[3] + delta);
// Stream 4
OFF_4_switch1 >= OFF_4_source1 + ceil(L[4] + delta);
...
// Stream 5
OFF_5_switch1 >= OFF_5_source3 + ceil(L[5] + delta);
OFF_5_switch2 >= OFF_5_switch1 + ceil(L[5] + delta);
...
// Switch 1
forall(alpha in 0..repetitions[2]-1, beta in 0..repetitions[3]-1) {
OFF_2_switch1 + alpha*T_period[2] <= OFF_3_source4 + beta*T_period[3] + (L[3] - delta)||
OFF_3_switch1 + beta*T_period[3] <= OFF_2_source2 + alpha*T_period[2] + (L[2] - delta);
}

forall(alpha in 0..repetitions[2]-1, beta in 0..repetitions[4]-1) {
OFF_2_switch1 + alpha*T_period[2] <= OFF_4_source1 + beta*T_period[4] + (L[4] - delta)||
OFF_4_switch1 + beta*T_period[4] <= OFF_2_source2 + alpha*T_period[2] + (L[2] - delta);
}

forall(alpha in 0..repetitions[2]-1, beta in 0..repetitions[5]-1) {
OFF_2_switch1 + alpha*T_period[2] <= OFF_5_source3 + beta*T_period[5] + (L[5] - delta)||
OFF_5_switch1 + beta*T_period[5] <= OFF_2_source2 + alpha*T_period[2] + (L[2] - delta);
}

forall(alpha in 0..repetitions[3]-1, beta in 0..repetitions[4]-1) {
OFF_3_switch1 + alpha*T_period[3] <= OFF_4_source1 + beta*T_period[4] + (L[4] - delta)||
OFF_4_switch1 + beta*T_period[4] <= OFF_3_source4 + alpha*T_period[3] + (L[3] - delta);
}

forall(alpha in 0..repetitions[3]-1, beta in 0..repetitions[5]-1) {
OFF_3_switch1 + alpha*T_period[3] <= OFF_5_source3 + beta*T_period[5] + (L[5] - delta)||
OFF_5_switch1 + beta*T_period[5] <= OFF_3_source4 + alpha*T_period[3] + (L[3] - delta);
}

forall(alpha in 0..repetitions[4]-1, beta in 0..repetitions[5]-1) {
OFF_4_switch1 + alpha*T_period[4] <= OFF_5_source3 + beta*T_period[5] + (L[5] - delta)||
OFF_5_switch1 + beta*T_period[5] <= OFF_4_source1 + alpha*T_period[4] + (L[4] - delta);
}
...
forall(alpha in 0..repetitions[1]-1, beta in 0..repetitions[5]-1) {
OFF_1_switch2 + alpha*T_period[1] <= OFF_5_switch1 + beta*T_period[5] + (L[5] - delta)||
...
forall(alpha in 0..repetitions[3]-1, beta in 0..repetitions[5]-1) {
OFF_3_switch2 + alpha*T_period[3] <= OFF_5_switch1 + beta*T_period[5] + (L[5] - delta)||
...
lambda_1 == OFF_1_switch3  - OFF_1_source5 + (trans_delay[1] + prop_delay);
lambda_2 == OFF_2_switch3  - OFF_2_source2 + (trans_delay[2] + prop_delay);
lambda_3 == OFF_3_switch4  - OFF_3_source4 + (trans_delay[3] + prop_delay);
lambda_4 == OFF_4_switch5  - OFF_4_source1 + (trans_delay[4] + prop_delay);
lambda_5 == OFF_5_switch5  - OFF_5_source3 + (trans_delay[5] + prop_delay);
