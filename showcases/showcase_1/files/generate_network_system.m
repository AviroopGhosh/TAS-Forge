...
%% Generate a file to gather CPLEX input

fprintf('Empty text file to input solution generated by CPLEX has been created.\n');

fileID      = fopen('input_cplex_solution.txt', 'w');
