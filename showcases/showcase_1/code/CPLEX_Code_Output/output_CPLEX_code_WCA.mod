...
// Stream 3
OFF_3_switch1 >= OFF_3_source4 + floor(L[3] - 1*delta);
...
// Stream 4
OFF_4_switch1 >= OFF_4_source1 + floor(L[4] - 1*delta);
...
// Stream 5
OFF_5_switch1 >= OFF_5_source3 + floor(L[5] - 1*delta);
OFF_5_switch2 >= OFF_5_switch1 + floor(L[5] - 0*delta);
...
forall(alpha in 0..repetitions[2]-1, beta in 0..repetitions[5]-1) {
OFF_5_switch1 - OFF_2_switch1 <= (alpha*T_period[2] - beta*T_period[5]) - ceil(trans_delay[5] + 2*delta + 1) ||
OFF_2_switch1 - OFF_5_switch1 <= (beta*T_period[5] - alpha*T_period[2]) - ceil(trans_delay[2] + 2*delta + 1);
}
...
forall(alpha in 0..repetitions[3]-1, beta in 0..repetitions[5]-1) {
OFF_5_switch1 - OFF_3_switch1 <= (alpha*T_period[3] - beta*T_period[5]) - ceil(trans_delay[5] + 2*delta + 1) ||
OFF_3_switch1 - OFF_5_switch1 <= (beta*T_period[5] - alpha*T_period[3]) - ceil(trans_delay[3] + 2*delta + 1);
}
...
// Port of switch5 towards sink3
forall(alpha in 0..repetitions[4]-1, beta in 0..repetitions[5]-1) {
OFF_5_switch5 - OFF_4_switch5 <= (alpha*T_period[4] - beta*T_period[5]) - ceil(trans_delay[5] + 2*delta + 1) ||
OFF_4_switch5 - OFF_5_switch5 <= (beta*T_period[5] - alpha*T_period[4]) - ceil(trans_delay[4] + 2*delta + 1);
}
...
lambda_2 == OFF_2_switch3  - OFF_2_source2 + (trans_delay[2] + prop_delay + delta);
lambda_3 == OFF_3_switch4  - OFF_3_source4 + (trans_delay[3] + prop_delay + delta);
lambda_4 == OFF_4_switch5  - OFF_4_source1 + (trans_delay[4] + prop_delay + delta);
lambda_5 == OFF_5_switch5  - OFF_5_source3 + (trans_delay[5] + prop_delay + delta);
