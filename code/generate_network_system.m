...
G = generate_linear_topology_graph(num_switch,num_src,num_sink,num_GM,true);
...
% if ne(src_repeats,0)
%     G = generate_linear_topology_graph(num_switch,num_src,num_sink,num_GM,false);
% end
...
function output = generate_linear_topology_graph(num_switch,num_src,num_sink,num_GM,doPlot)
